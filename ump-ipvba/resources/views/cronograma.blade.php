  ...
  <div class="card-body">
    <form action="{{route('cronograma-store')}}" method="POST">
        ...
        <div class="form-group">
            <label>Nome</label>
            <input name="evento" type="" class="form-control" id="" placeholder="Nome da Programação">
        </div>
        <div class="form-group">
            <label>Descrição do evento</label>
            <textarea name="descri" class="form-control" id="" rows="3"></textarea>
        </div>
        <div class="form-group">
            <label>Data</label>
        ...
        <div class="form-group">
            <label>Horário</label>
            <input name="horario" type="time" class="form-control"></input>
        </div>

        <div class="form-group">
            <label for="inputAddress">Local</label>
            <input name="local" type="text" class="form-control" placeholder="IPB Vila Buenos Aires">
        </div>        
        <div class="form-group">
            <label for="inputAddress">Endereço</label>
            <input name="end" type="text" class="form-control" placeholder="Rua dos Bobos, nº 0">
        </div>
